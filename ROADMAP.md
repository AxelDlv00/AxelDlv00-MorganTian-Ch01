...
| Hyperbolic/flat model functions `sn_k` and `ct_k`, Definition 1.30, pp. 48--49; `morganTian2007`, `petersen2006` Ch. 9, Section 1 | `Comparison.sn`, `Comparison.ct` | A1; define the radial coefficient piecewise at `k = 0` | G1-audited partial implementation S35; scalar and operator upper consumers implemented through `operator_riccati_le` at `cc1ad4e3d445dee8878b760182b07375a15571b9`; trace and determinant consumers pending |
| Positive-curvature spherical model for the upper comparison, implicit in the unnumbered analogue before `localdiffeo`, p. 49; `morganTian2007`, `petersen2016` Section 6.4, Cor. 6.4.2 and geometric cross-checks in Thms. 6.4.3/6.4.6, pp. 254--257 | `Comparison.snPos`, `Comparison.logDerivPos`, positivity and first-zero facts | A1; for `K > 0`, valid on `0 < r < pi / sqrt K`; explicit C1 input | G1-audited A1 implementation S36: total flat/spherical profile, ODE, first-pole radius/zero, and positivity implemented at `70cc263f77dc9ee70b6246a94edd00f3f7f6a13d`; origin limits, the regular logarithmic-derivative Riccati ODE, lower Riccati comparison, scalar Sturm comparison/positivity, public flat corollaries, and public exact-model checks implemented together in `Comparison.Model` at `e874c4c7b6126984488c487cbb78077828233457`; the interval-integral Riccati proof was isolated in `Comparison.PositiveRiccati` and both exact-model checks were made private at `24afcb8519006e44b680f6bf749aa64925d8f31e`; dimension-free operator upper and finite-dimensional operator lower comparisons, flat corollaries, and private exact-model checks implemented in `Comparison.OperatorRiccati` at `cc1ad4e3d445dee8878b760182b07375a15571b9`; trace and determinant comparison remain pending |
...
- **A1** (`G0`): hyperbolic/flat `sn`/`ct`, the positive-curvature `snPos` and
  ...
  Vector Sturm, trace Riccati, and determinant comparison remain open.
