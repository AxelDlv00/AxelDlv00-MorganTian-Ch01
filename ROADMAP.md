...
| `Curvature.Sectional` | connection-free `IsAlgebraicCurvature`, Gram-normalized sectional curvature, and constant-curvature identities | geometric witness discharge and quotient-of-planes/basis results; tangent facade owned by `Curvature.SectionalProvisional` |
