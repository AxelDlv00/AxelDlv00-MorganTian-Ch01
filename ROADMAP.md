...
| S18 | Geodesic equation, coordinate ODE, IVP uniqueness/smoothness: Definition 1.17 and following paragraph, p. 41; `morganTian2007`; `doCarmo1992`, Ch. 3, pp. 61--75 | `Geodesic.isGeodesic`, intrinsic IVP/maximal solution | F2 | S02 | prove chart ODE/intrinsic equivalence, interval maximality, and smooth dependence; a pointwise equation is insufficient | Open; candidate code is prior art only |
| S19 | Complete-space minimizing geodesics and Hopf--Rinow implication: paragraph before and Theorem 1.18, pp. 41--42; `morganTian2007`; `doCarmo1992`, Ch. 7, pp. 157--166; `lee2018`, Thm. 6.19 | `Geodesic.exists_minimizingGeodesic`, `hopfRinow` | F2 | S01 and S18 | connect metric completeness to the canonical maximal geodesic and minimizer existence, with connected-component assumptions explicit | Open; the rejected dependency's facade is not evidence |
