...
| Positive-curvature spherical model for the upper comparison, implicit in the unnumbered analogue before `localdiffeo`, p. 49; `morganTian2007`, `petersen2016` Section 6.4, Cor. 6.4.2 and Thms. 6.4.3/6.4.6, pp. 254--257 | `Comparison.snPos`, `Comparison.logDerivPos`, positivity and first-zero facts | A1; for `K > 0`, valid on `0 < r < pi / sqrt K`; explicit C1 input | total flat/spherical profile, ODE, first-pole radius/zero, and positivity implemented at `70cc263f77dc9ee70b6246a94edd00f3f7f6a13d`; origin limits, the regular logarithmic-derivative Riccati ODE, lower Riccati comparison, scalar Sturm comparison/positivity, and flat/exact-model checks implemented at `e874c4c7b6126984488c487cbb78077828233457`; vector/operator Riccati, trace, and determinant comparison pending |
...
- **A1** (`G0`): hyperbolic/flat `sn`/`ct`, the positive-curvature `snPos` and
  ...
  `e874c4c7b6126984488c487cbb78077828233457`; vector/operator Riccati, trace,
  and determinant comparison remain open.
...
| `A1-positive-scalar` / `e874c4c7b6126984488c487cbb78077828233457` | Completed the positive-curvature scalar boundary: both requested origin limits, strong logarithmic-derivative normalization, the regular Riccati ODE, the lower Riccati comparison used by the upper-sectional branch, scalar Sturm comparison and positivity, and flat/exact-model regressions | Morgan--Tian Definition 1.30 and upper-comparison discussion, pp. 48--49; Petersen 2016 Section 6.4, Cor. 6.4.2 and Thms. 6.4.3/6.4.6, pp. 254--257; pinned Mathlib derivative-slope, logarithmic derivative, interval-integral fundamental theorem, trigonometric bound, and derivative-monotonicity APIs; pinned Mathlib source search found no packaged geometric Riccati/Sturm analogue | Keep the API in standalone analytic A1 and expose it through the existing `Comparison.Model` root import; leave vector/operator Riccati, trace, determinant, and all manifold/Jacobi/polar bridges to dependent issues |
