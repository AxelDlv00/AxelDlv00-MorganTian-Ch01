...
revision implements its metric and Mathlib `C^1` distance/topology substrate
in `Ch01.Metric`, and its normalized-volume family in `Ch01.Volume`.  The
correspondence with Morgan--Tian's smooth-path distance remains pending.  G2
remains open until
