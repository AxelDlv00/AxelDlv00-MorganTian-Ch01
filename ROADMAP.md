...
| S20 | Energy, first variation, criticality, constant speed, and energy/length inequalities: pp. 41--43; `morganTian2007`; `doCarmo1992`, Ch. 9, pp. 185--201 | `Geodesic.energy`, `Geodesic.Variation.firstEnergyVariation` | F2 | S01--S02 and S18 | exact path/variation regularity, endpoint terms, and equality conditions must remain visible | **Partial.** `Ch01.Geodesic.Variation` now exports the canonical bundle-metric energy, real speed/length inequality with a.e.-constant equality case, interval additivity, positive affine reparameterization density contract, constant-speed/zero-velocity/sign regressions, a smooth two-parameter variation structure, the full endpoint first-variation formula, and a fixed-endpoint criticality equivalence conditional on an explicit test-field completeness witness. The S18 producer still discharges the covariant-acceleration and test-field bridge. |
