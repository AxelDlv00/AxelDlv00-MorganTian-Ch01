...
increment and completed G1 evidence audit recorded below.  The repository
revision containing [`docs/G2_SUBSTRATE_DECISION.md`](docs/G2_SUBSTRATE_DECISION.md)
