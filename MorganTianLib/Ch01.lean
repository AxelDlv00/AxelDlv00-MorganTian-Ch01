...
The public Chapter 1 umbrella.  It exposes the canonical Riemannian
metric/distance/volume coherence layer and the standalone scalar, traced
Riccati, and normalized determinant/density comparison layers.  Later
milestones add connection, curvature, geodesic, Jacobi, normal-coordinate,
