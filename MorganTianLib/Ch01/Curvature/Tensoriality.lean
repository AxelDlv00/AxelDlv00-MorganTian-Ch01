...
/-- Smooth local additivity in the curvature input slot. -/
...
/-- Constant-scalar homogeneity in the first curvature field slot. -/
...
/-- Constant-scalar homogeneity in the curvature input slot. -/
